  ...
  return (
    <>
      ...
      <div className=" lg:h-[499px] md:h-[650px]  h-[846px] w-auto mt-[170px] md:mt-0  bg-[#F0F0F0] ">
        {/* footer */}
        <div className="xl:w-[1240px] 2xl:w-[1340px] lg:w-[900px] md:w-[650px] md:h-[177px] md:flex md:justify-between md:gap-1 lg:gap-0  md:pl-[110px] pt-[180px] pl-[] md:pt-[120px] lg:pt-[140px] ">
          {/* 1 */}
          ...
          <div className="grid lg:grid-cols-4 grid-cols-2 pl-[20px] md:pl-0 ">
            {/* 2 */}
